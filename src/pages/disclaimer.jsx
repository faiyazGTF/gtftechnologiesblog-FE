    ...
    <Section className="p-30">
      ...
      <div className="mx-auto text-13 font-normal font-sans p-32 border-y">
        <Pera className="text-justify mb-10">
            <span className="font-bold text-15">Disclaimer: </span>
        ...
        <Pera className="mb-10">All designs, visuals, and photographs featured on this site are the intellectual property of Liv Interio or their respective owners and may not be reproduced, distributed, or used without prior written permission.</Pera>
        <Pera className="mb-10">Design outcomes can vary based on site conditions, client preferences, and other factors. Any reliance you place on the information provided is strictly at your own risk. We encourage consulting with our professional team for tailored advice before making design or renovation decisions.</Pera>
        <Pera className="mb-10">
